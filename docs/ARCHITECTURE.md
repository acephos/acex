...
| **Status** | G0/G1 and recommended G1.5 are done and usable; active G2 work is tracker-selected polish slices, with F35 ANSI cached peek polish and F36 board activity age polish shipped. |
